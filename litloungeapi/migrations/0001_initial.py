...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='work',
            name='genres',
            field=models.ManyToManyField(related_name='works', through='litloungeapi.WorkGenre', to='litloungeapi.Genre'),
        ),
        migrations.AddField(
            model_name='work',
            name='posted_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='litloungeapi.reader'),
        ),
        migrations.AddField(
            model_name='work',
            name='work_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='litloungeapi.worktype'),
        ),
        migrations.CreateModel(
            name='Talk',
            fields=[
